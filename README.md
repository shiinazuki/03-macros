...
[![build](https://github.com/shiinazuki/macros/actions/workflows/build.yaml/badge.svg)](https://github.com/shiinazuki/macros/actions/workflows/build.yaml)
[![audit](https://github.com/shiinazuki/macros/actions/workflows/audit.yaml/badge.svg)](https://github.com/shiinazuki/macros/actions/workflows/audit.yaml)
...
`main.rs` 里那行 `macros::greet(&name).context("...")?` 就是分界线：
...
- 过滤规则运行时可调：`RUST_LOG=warn,macros=debug`，不必重新编译；
